<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 1000px" placeholder="请输入名称" suffix-icon="el-icon-search" v-model="content"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm
          ...
          @confirm="delBatch"
      >
        <el-button type="danger"  style="margin-left: 10px" slot="reference">批量删除 <i class="el-icon-remove-outline"></i></el-button>
      </el-popconfirm>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="content" label="借阅设备"></el-table-column>
      <el-table-column prop="userId" label="借阅人id"></el-table-column>
      <el-table-column prop="username" label="借阅人用户名"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="true">
      <el-form label-width="140px" size="small" style="width: 85%;">
        <el-form-item label="借阅设备">
          <el-input v-model="form.content" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="借阅人id">
          <el-input v-model="form.userId" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="借阅人用户名">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open("http://47.103.201.137:9090/message/export")
    },
