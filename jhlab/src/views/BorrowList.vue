<template>
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-input style="width: 240px" placeholder="请输入设备名称" v-model="params.bookName"></el-input>
    ...
    <el-table :data="tableData" stripe row-key="id"  default-expand-all>
      ...
      <el-table-column prop="bookName" label="设备名称"></el-table-column>
...
<!--      <el-table-column prop="score" label="所用积分"></el-table-column>-->
      ...
      <el-table-column label="管理" >
        <template slot-scope="scope" v-if="scope.row.user === user.username || user.role === 'ROLE_ADMIN'">
          <el-button type="primary" @click="returnBooks(scope.row)" v-if="scope.row.status === '已借出'" >还设备</el-button>
        </template>
      </el-table-column>
