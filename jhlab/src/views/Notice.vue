  ...
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      >
       ...
       <el-upload action="http://47.103.201.137:9090/notice/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    handleAdd() {
      ...
      this.$nextTick(() => {
        if(!editor) {
          ...
          editor.config.uploadImgServer = 'http://47.103.201.137:9090/file/uploadImg'
...
// }
    ...
    exp() {
      window.open("http://47.103.201.137:9090/notice/export")
    },
