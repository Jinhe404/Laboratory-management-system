<template>
  <div>
    ...
    <el-table :data="tableData" stripe row-key="id"  default-expand-all>
      ...
      <el-table-column prop="bookNo" label="设备标准码"></el-table-column>
      <el-table-column prop="description"  label="描述"></el-table-column>
      <el-table-column prop="publishDate" label="出厂日期"></el-table-column>
      <el-table-column prop="author" label="负责老师"></el-table-column>
      <el-table-column prop="publisher" label="厂商"></el-table-column>
      <el-table-column prop="category" label="分类"></el-table-column>
      <el-table-column prop="score" label="可用数量"></el-table-column>
      ...
      <el-table-column label="操作" width="140">
        <template v-slot="scope">
          <!--          scope.row 就是当前行数据-->
          <el-button type="primary" @click="$router.push('/equipedit?id=' + scope.row.id)">编辑</el-button>
          <el-popconfirm
